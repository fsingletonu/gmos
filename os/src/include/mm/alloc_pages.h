 ...
 * (C) 2026 Guo Fu
 */
#ifndef _ALLOC_PAGES_H_
#define _ALLOC_PAGES_H_
...
typedef struct judge_buddy_struct
{
    bool buddy_free;    // 1 表示空闲
    bool front_or_back; // 这里 1 代表buddy为低地址 0 代表buddy为高地址
    page_t *buddy_PDesc;
} _packed judge_buddy_struct_t;
